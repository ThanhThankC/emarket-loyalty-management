// =============================================================
//  dang_nhap.js — App Thu Ngân
//  Chỉ đăng nhập, không đăng ký (quản lý tạo tài khoản)
//  Phụ thuộc: supabase_config.js, supabase_api.js, auth.js
// =============================================================
(function(){ if(getCurrentNV()) window.location.href='app_tn.html'; })();
...
async function handleLogin(e){
  ...
  try {
    ...
    setTimeout(()=>{ window.location.href='app_tn.html'; }, 700);
  } catch(err){
